	...
	<div class="row my-5 gyoon-link" align="center">
	  ...
	  <div class="gyoon-pd-mg">
		  ...
		  <div class="row my-5">		  
	  		  ...
	  		  <p class="fs-2 mt-5 gyoon-redressed">Create Admin Account</p>
	  		  <hr>
	  		  
	  		  <form method="post" action="adminWrite.do" name="adminForm" id="adminForm" enctype="multipart/form-data">
			  ...
			  <div class="col-md-10 mt-3"> <!-- col -->
			    <table class="fs-4 align-middle label-mg boxes">
			      <tr>
			        ...
			        <td><input class="form-control form-control-sm box" type="text" placeholder="Start with Eng(5~20)(Eng,Num)" name="userid" id="userid"></td>
			      </tr>
			      <tr>
			      ...
			      <tr>
			        <td><label for="uploadfile" class="mx-5">Profile Image</label></td>
			  ...
			  <div class="d-flex justify-content-center my-5">
			  	<span class="p-1 px-4 me-2 button-hover" id="create">Create</span>
			  </div>
...
$("#userid").blur(function(){
	...
	$.ajax({
		type:"get",
		url:"/admin/checkUserId.do?userid=" + userid,
		dataType:"json", 
...
$("#nickname").blur(function(){
	...
	$.ajax({
		type:"get",
		url:"/admin/checkNickname.do?nickname=" + nickname,
		dataType:"json", 
		success:function(data){ 
			console.log(data);
...
$("#create").on("click", function() {
	...
	if( !idExp.test($("#userid").val()) ){
		alert('ID must start with an English letter and be at least 5 characters long (special character X).');
		$("#userid").val("");
		$("#userid").focus();
		return false;
	}
	...
	if( confirm('You sure to create New Admin Account?') ){
		$("#adminForm").submit();
	}else{ return false; }
});
