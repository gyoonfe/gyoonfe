	...
	<div class="row my-5 gyoon-link" align="center">
	  ...
	  <div class="gyoon-pd-mg">
		  ...
		  <div class="row my-5">		  
	  		  ...
	  		  <p class="fs-2 mt-5 gyoon-redressed">Update Admin Profile</p>
	  		  <hr>
	  		  
	  		  <form method="post" action="adminUpdate.do" name="adminForm" id="adminForm" enctype="multipart/form-data">
			  ...
			  <div class="col-md-10 mt-3"> <!-- col -->
			    <table class="fs-4 align-middle label-mg boxes">
			      <tr>
			        <td><label for="userid" class="mx-5">ID  </label></td>
			        <td><input class="form-control form-control-sm box bg-white" type="text" name="userid" id="userid" value="${mVO.userid}" readonly="readonly"></td>
			      </tr>
			      <tr>
			        <td><label for="pass" class="mx-5">Password</label></td>
			        <td><input class="form-control form-control-sm box" type="password" placeholder="(low+up+num),(6~20),(~!@\#$%<>^&*)" name="pass" id="pass"></td>
			      </tr>
			      <tr>
			        <td><label for="pass2" class="mx-5">Password Check</label></td>
			      ...
			      <tr>
			        ...
			        <td><input class="form-control form-control-sm box" type="text" placeholder="Name" name="mname" id="mname" value="${mVO.mname}"></td>
			      </tr>
			      <tr>
			        <td><label for="nickname" class="mx-5">Nickname</label></td>
			        <td><input class="form-control form-control-sm box" type="text" placeholder="Nickname" name="nickname" id="nickname" value="${mVO.nickname}"></td>
			      </tr>
			      <tr>
			      ...
			      <tr>
			        ...
			        <td><input class="form-control form-control-sm box" type="text" name="email" id="email" value="${mVO.email}"></td>
			      ...
			      <tr>
			        ...
			        <td><input class="form-control form-control-sm box" type="text" name="phone" id="phone" value="${mVO.phone}"></td>
			      </tr>
			      <tr>
			        <td><label for="zipcode" class="mx-5">Zip Code</label></td>
			        <td><input class="form-control form-control-sm bg-white box" type="text" name="zipcode" id="sample2_postcode" value="${mVO.zipcode}" readonly></td>
			        <td><span class="fs-5 px-2 mx-3 button-hover" onClick="sample2_execDaumPostcode()">Search</span></td>
			      </tr>
			      <tr>
			        <td rowspan="2"><label for="sample2_detailAddress" class="mx-5">Address</label></td>
			        <td><input class="form-control form-control-sm bg-white box" type="text" name="address1" id="sample2_address" value="${mVO.address1}" readonly></td>
			      </tr>
			      <tr>
			        <td><input class="form-control form-control-sm box" type="text" name="address2" value="${mVO.address2}" id="sample2_detailAddress"></td>
			      </tr>
			      <tr>
			        <td><label for="uploadfile" class="mx-5">Image Change</label></td>
			        <td><input class="form-control form-control-sm box" type="file" name="uploadfile" id="uploadfile"></td>
			      </tr>
			      <tr>
			        <td><label for="" class="mx-5">Image</label></td>
			        <td>
			          <c:choose>
			            <c:when test="${mVO.mprofile != null && mVO.mprofile ne '' }">
			              <img src="/upload_gyoontar/member/${mVO.mprofile}" alt="..." class="mprofile-size">
			            </c:when>
			            <c:otherwise>
			              <img src="/resources/images/non_profile.png" alt="..." class="mprofile-size">
			            </c:otherwise>
			          </c:choose>
			        </td>
			      </tr>
			  ...
			  <div class="d-flex justify-content-center my-5">
			  	<span class="p-1 px-4 me-2 button-hover" id="update">Update</span>
			  </div>
...
$("#nickname").blur(function(){
	...
	$.ajax({
		type:"get",
		url:"/admin/checkUpdateNickname.do?nickname="+nickname+"&userid="+userid,
		dataType:"json", 
...
// sex가 1일 때, Male에 selected 옵션 주기
$(document).ready(function() {
	var sex = '<c:out value="${mVO.sex}"/>'
	if( parseInt(sex) == 1 ){
...
$("#update").on("click", function() {
	...
	if( confirm('You sure to update this Account?') ){
		$("#adminForm").submit();
	}else{ return false; }
});
